export const FacilityReviews = [
  ...
  },
  {
    ...
    review:"Clipboard has helped alleviate the stress of unfilled shifts and working shorthanded",
    rating:5,
  },
]
...
export const CustomerReviews = [
  {
    id:5,
    name:"WAMARL 19",
    review:"High Pay Always Fast. Their shifts always pay me the most and they pay immediately no one else does this. I’m really happy I'm working with them. They're great.",
    rating:5,
  },
  {
    id:6,
    name:"E DAVENPORT",
    review:"I wish more facilities in Oklahoma used clipboard. I absolutely love clipboards for my agency shifts! They are great about getting issues resolved.",
    rating:5,
  },
  {
    id:7,
    name:"Romanie Brandee",
    review:"Really good. Whenever you need one important shift covered, or you are looking to broadcast thousands of shifts, clipboard is always there to help.",
    rating:5,
  },
  {
    id:8,
    name:"Schmitz Mattison",
    review:"Recommended. Very simple fast process I started my process on a Tuesday and I was ready to start working on that wednesday. I'm very happy with the process.",
    rating:5,
  }
